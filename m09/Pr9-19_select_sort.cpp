...
int main()
{
   const int NUM_DONATIONS = 10;  // Number of donations

   // An array containing the donation amounts.
   int donations[NUM_DONATIONS] = { 88, 99, 44, 22, 11,
                                    33, 66, 55, 01, 77};
...
///// next two lines are inserted to view the changes of each inner loop
